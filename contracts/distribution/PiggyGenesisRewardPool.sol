...
contract PiggyGenesisRewardPool {
    ...
    // TESTNET
    uint256 public piggyPerSecond = 3.0555555 ether; // 11000 PIGGY / (1h * 60min * 60s)
    uint256 public runningTime = 24 hours; // 1 hours
    uint256 public constant TOTAL_REWARDS = 11000 ether;
    // END TESTNET

    // MAINNET
    // uint256 public piggyPerSecond = 0.11574 ether; // 10000 PIGGY / (24h * 60min * 60s)
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 amount, address to) external onlyOperator {
        if (block.timestamp < poolEndTime + 90 days) {
            // do not allow to drain core token (PIGGY or lps) if less than 90 days after pool ends
